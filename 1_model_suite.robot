...
*** Settings ***
# Utilizado para importar bibliotecas/libs ou 
# outros arquivos dentro do projeto
...
# Utilizado para escrever variáveis estáticas, 
# xpath, variáveis globais
...
# Precisa ser importada pelo Caso de teste 
# se não estiver no mesmo arquivo
